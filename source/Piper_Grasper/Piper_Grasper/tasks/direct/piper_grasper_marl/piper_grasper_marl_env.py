...
from .piper_grasper_marl_env_cfg import PiperGrasperMarlEnvCfg


class PiperGrasperMarlEnv(DirectMARLEnv):
    cfg: PiperGrasperMarlEnvCfg

    def __init__(self, cfg: PiperGrasperMarlEnvCfg, render_mode: str | None = None, **kwargs):
